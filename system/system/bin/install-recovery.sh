#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/platform/bootdevice/by-name/recovery:25165824:16892ba984ae1558eb7f6ffa2ec7acd84b5feca8; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/platform/bootdevice/by-name/boot:25165824:b6a71522d991566f4f570ba93453e35889450b5e \
          --target EMMC:/dev/block/platform/bootdevice/by-name/recovery:25165824:16892ba984ae1558eb7f6ffa2ec7acd84b5feca8 && \
